  ...
  return (
    <>
      ...
      <div className="body header-fixed header-pages">
        <OriginalHeader pageTitle="أفلام | اكوام" />
            ...
            <div className="widget-2 archive-content">
              <div className="widget-body">
                {isLoading ? (
                  ...
                  <div className="row">
                    {moviesData?.data?.filter((item: ContentItem) => item.type === 'movie')
                      .map((movie: ContentItem) => (
                      <div key={movie.id} className="col-lg-2 col-md-3 col-4 col-xs-6 mb-12">
                        <div className="block relative">
                          <a href={`/movie/${movie.id}`} className="img">
                            <img 
                              className="img-fluid"
                              src={movie.poster || '/serverdata/images/default-poster.svg'}
                              alt={movie.titleAr}
                              loading="lazy"
                            />
                            <div className="absolute-container">
                              <div className="layer">
                                ...
                                <div className="info">
                                  <div className="title">{movie.titleAr}</div>
                                  <div className="sub-title">{movie.title}</div>
                                  <div className="labels">
                                    <span className="label label-primary">{movie.quality}</span>
                                    <span className="label label-year">{new Date(movie.releaseDate).getFullYear()}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
