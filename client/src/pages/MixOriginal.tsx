...
const MixOriginal = () => {
  ...
  const { data: mixData, isLoading } = useQuery({
    queryKey: ['/api/content', { category: 'mix', ...filters }],
    enabled: true
  });
  ...
  return (
    <>
      ...
      <div className="body header-fixed header-pages">
        <OriginalHeader pageTitle="منوعات | اكوام" />
                          ...
                          <div className="col-lg-3 col-md-6 col-12">
                            <div className="form-group mb-12">
                              ...
                              >
                                ...
                                <option value="31">العاب</option>
                                <option value="32">برامج</option>
                                <option value="33">اغاني</option>
                              </select>
                            </div>
                          </div>
                          <div className="col-lg-3 col-md-6 col-12">
                            <div className="form-group mb-12 mb-lg-0">
                              ...
                              >
                                ...
                                <option value="50">العاب</option>
                                <option value="51">برامج</option>
                                <option value="52">اغاني</option>
                                <option value="53">كتب</option>
                                <option value="54">تطبيقات</option>
                                <option value="55">تعليمي</option>
                                <option value="56">منوعات</option>
                              </select>
                            </div>
                          </div>
                          <div className="col-lg-3 col-md-6 col-12">
            ...
            <div className="widget-2 archive-content">
              <div className="widget-body">
                {isLoading ? (
                  ...
                  <div className="row">
                    {mixData?.data?.map((item: ContentItem) => (
                      <div key={item.id} className="col-lg-2 col-md-3 col-4 col-xs-6 mb-12">
                        <div className="block relative">
                          <a href={`/mix/${item.id}`} className="img">
                            <img 
                              className="img-fluid"
                            ...
                            <div className="absolute-container">
                              <div className="layer">
                                ...
                                <div className="info">
                                  <div className="title">{item.titleAr}</div>
                                  <div className="sub-title">{item.title}</div>
                                  <div className="labels">
                                    <span className="label label-primary">{item.quality}</span>
                                    <span className="label label-year">{new Date(item.releaseDate).getFullYear()}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
